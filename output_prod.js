{
      ...
      /* config.module.rule('vue') */
      {
        ...
        use: [
          /* config.module.rule('vue').use('cache-loader') */
          {
            loader: 'cache-loader',
            options: {
              cacheDirectory: 'E:\\vuecli3_ssr\\node_modules\\.cache\\vue-loader',
              cacheIdentifier: 'f9269ef6'
            }
          },
  ...
  plugins: [
    ...
    new HtmlWebpackPlugin(
      {
        ...
        template: 'E:\\vuecli3_ssr\\public\\index.html'
      }
    ),
    ...
    new CopyWebpackPlugin(
      [
        {
          from: 'E:\\vuecli3_ssr\\public',
          to: 'E:\\vuecli3_ssr\\dist',
          toType: 'dir',
          ignore: [
            'index.html',
            '.DS_Store'
